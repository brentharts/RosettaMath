...
\item \textbf{Not yet the theorems about pairs.}  That a disjoint
  region list has no two overlapping regions, and that an address belongs
  to at most one owner, are quantified over positions; RosettaMath proves
  them about hand-typed models, and the Rust ports' contracts do not reach
  them yet.  They will take proofs directed by hand against the lifted
  models, as \texttt{bump\_bounded} was.
